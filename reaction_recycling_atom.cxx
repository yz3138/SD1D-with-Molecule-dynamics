...
class ReactionRecycling_atom : public Reaction {
public:
  ReactionRecycling_atom(Options *options) {
    AUTO_TRACE();
  ...
  std::string str() const { return "Atom recycling "; }
...
namespace {
RegisterInFactory<Reaction, ReactionRecycling_atom> register_reca("recycling_atom");
}
