...
class ReactionIonchargedH2_1 : public Reaction {
public:
  ReactionIonchargedH2_1(Options *options) {
...
//    auto &atoms     = *species.at('h')
    ...
    CELL_AVERAGE(i,                        // Index variable
      ...
      BoutReal R =
        Ne * Nm_c * hydrogen.Ion_charged_H2_1(Te*Tnorm) * (Nnorm / Omega_ci);
...
namespace {
RegisterInFactory<Reaction, ReactionIonchargedH2_1> register_im("ion_m_1");
}
