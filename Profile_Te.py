...
Te_w_w_1e5_elastic = collect("Te",path='lossrate_1e5_H2c_elastic')
Te_w_w_1e5_elastic_H2_pump = collect("Te",path='lossrate_1e5_H2c_elastic_H2_pumping')
...
plt.show()
############
plt.plot(pos-0.54,Te_w_w_1e5[t,0,:,0]*tnorm,label='pumping H')
plt.plot(pos-0.54,Te_w_w_1e5_elastic[t,0,:,0]*tnorm,label='pumping H,elastic')
plt.plot(pos-0.54,Te_w_w_1e5_elastic_H2_pump[t,0,:,0]*tnorm,label='pumping H and H2,elastic')
